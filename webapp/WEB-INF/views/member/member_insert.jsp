...
<body>
 <nav class="navbar navbar-expand-md bg-dark navbar-dark text-white">
  <div class="container">
   ...
   <div id="toggle" class="navbar-collapse collapse">
    ...
    <ul class="navbar-nav ml-auto">
     <li class="nav-item dropdown mr-3">     
        <li class="nav-item">
         <a href="./PetMemberInsert" class="nav-link">
   ...
   <li>  <a href="./pets" class="navbar-brand">
   ...
   <div class="row">
    <div class="col-md-12">
     <div class="card">
      ...
      <div class="card-body">
       <form action="./MemberInsert" method="post" id="signupForm" class="" enctype="application/x-www-form-urlencoded">
        <fieldset>
