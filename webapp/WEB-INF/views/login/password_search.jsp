   ...
   <div class="row">
    <div class="col-9 mx-auto">
     <div class="card">
      ...
      <div class="card-body">
       <form action="./PasswordCheck" method="post" id="signupForm" enctype="application/x-www-form-urlencoded">
        <fieldset>
    ...
    <div class="col-9 mx-auto py-3 mb-3">
     <div>      
      <span>
       <button type="button" class="btn btn-outline-success" onclick="location.href='./IdSearchCheck'">
