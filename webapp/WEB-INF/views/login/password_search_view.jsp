...
<body>
 <header id="main-header" class="py-2 bg-secondary text-white">
  <div class="container">
   ...
   <li>  <a href="./pets" class="navbar-brand text-white">
 ...
 <section id="login">
  <div class="container">
   <div class="row">
    <div class="col-9 mx-auto">
     <div class="card">
      ...
      <c:choose>
       <c:when test="${!empty login.password}">
        <div class="row pb-1 justify-content-center">
        <p class="text-success"> 찾으시는 비밀번호는
         <b class="text-info">${login.password}</b>
        입니다. </p>
   ...
   <div class="col-9 mx-auto py-3 mb-3">
    <div>
     <span>
       <button type="button" class="btn btn-outline-success" onclick="./IdSearchCheck'">
